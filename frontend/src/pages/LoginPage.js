          ...
          <section style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{
                ...
                Track your professional presence, score your branding profile, and turn weak spots into focused next steps.
              </p>
              ...
              <div style={{
                ...
                {[
                  ...
                  'Work inside a cleaner, more structured experience inspired by modern academic and admissions platforms.'
                ].map((item) => (
                  <div
                    key={item}
                    style={{
          ...
          <section style={{
            ...
            <div style={{ marginBottom: 30 }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: 15, lineHeight: 1.6 }}>
                Access your profile branding workspace and continue improving your professional presence.
              </p>
            </div>
